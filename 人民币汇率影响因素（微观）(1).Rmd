...
data1 <- data
data1[nrow(data1),2] <- data1[nrow(data1),2] + 0.13
data1[nrow(data1)-1,2] <- data1[nrow(data1)-1,2] + 0.12
data1[nrow(data1)-2,2] <- data1[nrow(data1)-2,2] + 0.17
data1[nrow(data1)-3,2] <- data1[nrow(data1)-3,2] + 0.1
data1[nrow(data1)-4,2] <- data1[nrow(data1)-4,2] + 0.2
